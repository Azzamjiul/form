      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              You have used all your available attempts for this{" "}
              {validation.form?.form_type || "form"}.
            </p>
            <p className="mt-4 text-sm text-gray-500">
      ...
      <div className="max-w-2xl w-full bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-4 mb-8">
            ...
            <ul className="space-y-2 text-sm text-blue-800">
              <li className="flex items-center">
                ...
                <span className="font-medium ml-1 capitalize">
                  {validation.form?.form_type}
                </span>
              </li>
              {validation.form?.time_limit_minutes &&
                validation.form.time_limit_minutes > 0 && (
                  <li className="flex items-center">
                    <svg
                      className="h-5 w-5 mr-2"
                      fill="none"
                    ...
                    <span className="font-medium ml-1">
                      {validation.form.time_limit_minutes} minutes
                    </span>
                  </li>
                )}
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                ...
                Expires:{" "}
                <span className="font-medium ml-1">
                  {new Date(validation.expires_at || "").toLocaleString()}
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-yellow-800">
              ...
              <li>
                You can navigate between questions before final submission
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          ...
          >
            {isStarting
              ? "Starting..."
              : `Start ${validation.form?.form_type === "quiz" ? "Quiz" : "Survey"}`}
          </button>
        </div>

        <p className="mt-4 text-xs text-center text-gray-500">
          By starting, you agree to complete the {validation.form?.form_type}{" "}
